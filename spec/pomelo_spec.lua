  ...
  describe('Client', function()
    ...
    describe(':request()', function()
      ...
      it('timeout are optional', function()
        ...
        assert.has_no.errors(function()
          c:request('connector.entryHandler.entry', '{"name": "test"}', callback)
        end)
        assert.has_error(function()
          c:request('connector.entryHandler.entry', '{"name": "test"}')
        end)
        assert.has_error(function()
          c:request('connector.entryHandler.entry', '{"name": "test"}', 10)
        end)
        sleep(2)
        c:poll()
        assert.spy(callback).was.called(1)
    ...
    describe(':notify()', function()
      ...
      it('timeout and callback are optional', function()
        ...
        local s = spy.new(function() end)
        assert.has_no.errors(function()
          c:notify('test.testHandler.notify', '{"content": "test content"}', 10)
        end)
        assert.has_no.errors(function()
          c:notify('test.testHandler.notify', '{"content": "test content"}', s)
        end)
        assert.has_no.errors(function()
          c:notify('test.testHandler.notify', '{"content": "test content"}')
        end)
        sleep(2)
        c:poll()
        assert.spy(s).was.called(1)
